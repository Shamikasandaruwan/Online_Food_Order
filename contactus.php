...
<html>
  ...
  <head>
    <title> Contact | Moon Shade' </title>
  </head>
...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-user"></span> Welcome <?php echo $_SESSION['login_user1']; ?> </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Moon Shade' </span>?</strong>
     <br>
