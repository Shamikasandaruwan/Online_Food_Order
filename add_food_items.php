...
if(isset($_POST['submit'])) 
{
  ...
  $insert="insert into food values('$images_path')";
  if(mysql_query($insert))
  {
    move_uploaded_file($_FILES['image']['tmp_name'], "uploads/$img");
    echo "<script>alert('image has upload')</script>";
  }
  else 
  {
   echo "<sript>alert('image has not upload')</script>";
  }
}
...
<html>
  ...
  <head>
    <title> Manager Login | Moon Shade' </title>
  </head>
...
<div class="container">
    ...
    <form action="upload.php" method="post" enctype="multipart/form-data">
            ...
            <label> Select to food image to upload:</label>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button type="submit" value="Upload Image" id="submit" name="submit" class="btn btn-primary pull-right"> ADD FOOD </button>    
      </div>
        </form>
