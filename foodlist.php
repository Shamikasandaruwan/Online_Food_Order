...
<html>
  ...
  <head>
    <title> Explore | Food Moon Shade' </title>
  </head>
...
<div class="jumbotron">
  <div class="container text-center">
    <h1>Welcome To Moon Shade'</h1>      
    <!--p>Let food be thy medicine and medicine be thy food</p--><!--<img src="images/2716.jpg">-->
  </div>
</div>
...
<h5 class="text-danger">Ru <?php echo $row["price"]; ?>/-</h5>
